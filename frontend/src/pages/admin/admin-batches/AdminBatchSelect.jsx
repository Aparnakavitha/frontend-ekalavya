...
import { fetchBatchParticipants, updateBatch , deleteBatch,postUserIds} from "../../../services/Batch";
  ...
  return (
    <div>
      ...
      <AdminBatchSearch
        ...
        batchName={batchName}
      />
        <AdminBatchParticipants batchId={batchId} onParticipantsAdded={handleParticipantsAdded} />
