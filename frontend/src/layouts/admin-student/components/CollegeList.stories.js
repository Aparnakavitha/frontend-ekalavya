...
export default {
  ...
  args: {
    data: [
      ["CLG001", "Massachusetts Institute of Technology", "Cambridge", "Massachusetts", "USA"],
      ["CLG002", "Stanford University", "Stanford", "California", "USA"],
      ["CLG003", "Harvard University", "Cambridge", "Massachusetts", "USA"],
      ["CLG004", "California Institute of Technology", "Pasadena", "California", "USA"],
      ["CLG005", "University of Oxford", "Oxford", "Oxfordshire", "UK"],
      ["CLG006", "University of Cambridge", "Cambridge", "Cambridgeshire", "UK"],
      ...
      ["CLG010", "National University of Singapore", "Singapore", "Singapore", "Singapore"],
      ...
      ["CLG014", "University of California, Berkeley", "Berkeley", "California", "USA"],
      ["CLG015", "University of Pennsylvania", "Philadelphia", "Pennsylvania", "USA"],
      ["CLG016", "University of California, Los Angeles", "Los Angeles", "California", "USA"],
