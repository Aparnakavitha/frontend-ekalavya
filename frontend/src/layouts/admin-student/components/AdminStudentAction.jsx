  ...
  return (
    <div>
      ...
      <Modal isOpen={isOpen} onClose={handleCloseModal}>
        <AddUser
          options={AdminStudentActionData.adduserprops.options}
          viewCollege={AdminStudentActionData.adduserprops.viewCollege}
          heading={AdminStudentActionData.adduserprops.heading}
